...
//! Extracted verbatim from ntt/reverence (BSD-licensed), file
//! `src/strings.py` (`stringTable`), commit 9ded85506f5970d8842e1a27d32afa83600d20ac;
//! order matters — the wire index is a direct index into this table.
//!
//! Index 0 is a reserved placeholder (`None` in reverence; marshal.c:631
//! rejects indices < 1), so valid wire indices are 1..=255. Entries
//! "#196".."#255" are unknown-slot fillers, also verbatim from reverence.
pub static STRING_TABLE: &[&str] = &[
    "", // index 0: reserved/invalid (None in reverence strings.py)
    "*corpid",
    "*locationid",
    "age",
    "Asteroid",
